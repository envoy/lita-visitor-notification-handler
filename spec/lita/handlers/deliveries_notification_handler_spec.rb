...
describe Lita::Handlers::DeliveriesNotificationHandler, lita_handler: true do
  ...
  let(:message) do
    'You have a delivery from US Postal Service!<http://localhost:3001/a/deliveries/user_actions/acknowledge?id=0939f462-2b2a-4e1e-aba0-bb7aafbff7d4&token=eyJhb....'
  end
